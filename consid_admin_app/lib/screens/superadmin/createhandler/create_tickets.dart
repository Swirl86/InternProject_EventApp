      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            defaultTextTitle(
                _screenSize, "Create Tickets", _screenSize.width * 0.09),
            ...
            defaultTextButton(context, LocalVar.send.toUpperCase(), () {
              if (_formKey.currentState!.validate()) {
                List<TicketTypeModel> sendModelList = <TicketTypeModel>[];

                modelList.forEach((aTicketType) {
                  for (int i = 0; i < aTicketType.amount; i++) {
                    sendModelList.add(aTicketType);
                  }
                });

                db.addTickets(context, sendModelList);
              }
            },
